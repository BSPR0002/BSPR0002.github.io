	...
	static requestPermission(deprecatedCallback=null){
		if (this.#permission=="default") {
			...
			var processor=this.requestingPermission?this.#requestProcessor:this.#requestProcessor=new Promise(function(resolve){
				...
				Interface.style="position:fixed;margin:8px;width:320px;height:128px;top:0;left:0;box-sizing:border-box;display:none;grid-template-rows:auto 20px 32px;grid-gap:10px;padding:16px;box-shadow:0px 0px 8px #000000;border-radius:4px;background-color:#FFFFFF;color:#000000;opacity:0;transition:opacity 0.3s ease-in-out;z-index:2147483647";
				...
				var PermissionIcon=document.createElement("div");
				PermissionIcon.style="width:20px;height:20px;background-image:url(data:image/svg+xml;base64,)";
				...
				var canvas=CloseIcon.getContext("2d");
