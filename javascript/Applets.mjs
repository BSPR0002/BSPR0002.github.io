...
const { frame, listFrame, searchButtonState, searchButton, searchInput, backTop, list, partFav, listFav, listAll, detailStyle } = parseAndGetNodes([
	["div", [
		["style", [
			...
			"#applets_search_button{position:relative;overflow:hidden;font-size:0.875rem;padding:0 0.25rem!important;border:0}",
			...
			".applets_item{display:grid;gap:0.25rem;border-radius:0.5rem!important;padding:0.5rem!important;border:0}",
			".applets_item_name{white-space:nowrap;max-width:100%;overflow:hidden;text-overflow:ellipsis}",
			".applets_item_start{background-color:#FFFFFF!important;padding:0.25rem!important;border:0}",
