...
const { frame, listFrame, searchButtonState, searchButton, searchInput, backTop, list, partFav, listFav, listAll, detailStyle } = parseAndGetNodes([
	["div", [
		["style", [
			...
			"#applets-search-input:focus{outline-color:var(--focusColor)}",
			...
			".applets-list-part-title,#applets-list::before{background-color:var(--backgroundColor);box-sizing:border-box;padding:0.5rem;border-radius:0.5rem;margin-bottom:0.5rem}",
			...
			".applets-item-start:active{background-color:var(--activeColor)!important}",
	...
	["style", [
		...
		"#applets-detail-interface{display:grid;width:100%;grid-template-rows:6rem auto auto;grid-template-columns:1fr 1fr;grid-template-areas:\"icon icon\"\"name name\"\"fav start\";gap:0.5rem;border-radius:0.5rem;box-sizing:border-box;padding:0.5rem;place-items:center;background-color:var(--backgroundColor);color:#000}",
		...
		"#applets-detail-fav:hover{background-color:var(--hoverColor)!important}",
		"#applets-detail-fav:active{background-color:var(--activeColor)!important}",
		...
		"#applets-detail-start:active{background-color:var(--activeColor)!important}",
		...
		"#applets-detail-info.load{background-color:var(--backgroundColor);box-sizing:border-box;padding:0.5rem;border-radius:0.5rem;}",
	], null, "detailStyle"]
]).nodes;
