...
const { layer, windowBody, windowTitle, windowQueue, windowClose, windowContent, contentFrame, confirmStyle, subLayer, subTitle, subFrame, subBody } = ArrayHTML([
	["DIV", [
		["STYLE", [
			...
			"#MiniWindow,#MiniWindowSub{box-sizing:border-box;place-self:center;min-width:16rem;min-height:8rem;max-width:80%;max-height:80%;overflow:hidden;border-radius:0.75rem;padding:0.75rem;display:grid;grid-template-rows:1.25rem auto 1fr;background-color:var(--MiniWindow_backgroundColor,#FFFFFF);color:var(--MiniWindow_textColor,#000000);font-size:0.9375rem;user-select:text}",
			...
			"#MiniWindow button,#MiniWindowQueue{background-color:var(--MiniWindow_buttonBackgroundColor,#CCCCCC);color:var(--MiniWindow_buttonTextColor,#000000);user-select:none}",
			"#MiniWindow button:hover{background-color:var(--MiniWindow_buttonHoverBackgroundColor,#7FBFFF);color:var(--MiniWindow_buttonHoverTextColor,#000000)}",
			"#MiniWindow button:active:focus{background-color:var(--MiniWindow_buttonActiveBackgroundColor,#0080FF);color:var(--MiniWindow_buttonActiveTextColor,#FFFFFF)}",
			...
			"#MiniWindowQueue{box-sizing:border-box;border:solid 0.125rem var(--MiniWindow_textColor,#000000);border-radius:0.25rem;overflow:hidden;display:grid;place-content:center;font-size:0.75rem}",
			"#MiniWindowClose{position:relative;border-radius:0.25rem}",
			"#MiniWindowClose::before,#MiniWindowClose::after{content:\"\";position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;border-radius:0.0625rem;width:0.125rem;height:1rem;background-color:var(--MiniWindow_buttonTextColor,#000000);transform:rotate(45deg)}",
			"#MiniWindowClose::before{transform:rotate(-45deg)}",
			"#MiniWindowClose:hover::before,#MiniWindowClose:hover::after{background-color:var(--MiniWindow_buttonHoverTextColor,#000000)}",
			"#MiniWindowClose:active::before,#MiniWindowClose:active::after{background-color:var(--MiniWindow_buttonActiveTextColor,#FFFFFF)}",
			"#MiniWindowHR,#MiniWindowSubHR{box-sizing:border-box;width:100%;border:solid 0.0625rem var(--MiniWindow_textColor,#000000);border-radius:0.0625rem;background-color:var(--MiniWindow_textColor,#000000)}",
			...
			"#MiniWindowContent{position:relative;max-width:100%;max-height:100%;width:100%;height:100%;overflow:auto;word-wrap:break-word;word-break:normal;color:var(--MiniWindow_textColor,#404040);user-select:text}",
